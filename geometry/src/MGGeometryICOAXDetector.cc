...
{
  MGLog(trace) << "Settings for MGGeometryICOAXDetector:" << endlog;
  MGLog(trace) << "----------------------------------------" << endlog;
  MGLog(trace) << "Dimensions are in cm." << endlog;
  MGLog(trace) << "fCoreRadius: " << fCoreRadius/cm << endlog;
  MGLog(trace) << "fCoreDepth: " << fCoreDepth/cm << endlog;
  MGLog(trace) << "fHeight: " << fHeight/cm << endlog;
  MGLog(trace) << "fRadius: " << fRadius/cm << endlog;
  MGLog(trace) << "fCoreBubbleOn: " << fCoreBubbleOn << endlog;
  MGLog(trace) << "fCoreRounding: " << fCoreRounding << endlog;
  MGLog(trace) << "fCornerRadius: " << fCornerRadius/cm << endlog;
  MGLog(trace) << "fBeveledEdgeConsidered:  " << fBeveledEdgeConsidered << endlog;
  MGLog(trace) << "fBeveledEdgeAngle:  "<< fBeveledEdgeAngle/deg << endlog;
  MGLog(trace) << "fBeveledEdgeT:  " << fBeveledEdgeT/mm << endlog;
  MGLog(trace) << "fExcessSideDeadLayerConsidered:  "<<fExcessSideDeadLayerConsidered << endlog;
  MGLog(trace) << "fExcessSideDeadLayerThickness:  "<<fExcessSideDeadLayerThickness<< endlog;
  MGLog(trace) << "fOuterDeadLayerThickness: " << fOuterDeadLayerThickness/cm << endlog;
  MGLog(trace) << "fCoreDeadLayerThickness: " << fCoreDeadLayerThickness/cm << endlog;
  MGLog(trace) << "fDeadLayerConsidered: " <<  fDeadLayerConsidered << endlog; 
  /*
    MGLog(trace) << "fExtraDeadLayerConsidered: " <<  fExtraDeadLayerConsidered << endlog; 
    MGLog(trace) << "fExtraDeadLayerBottomZ: " <<  fExtraDeadLayerBottomZ/cm << endlog; 
    MGLog(trace) << "fExtraDeadLayerMiddleZ: " <<  fExtraDeadLayerMiddleZ/cm << endlog; 
    MGLog(trace) << "fExtraDeadLayerTopZ: " <<  fExtraDeadLayerTopZ/cm << endlog; 
    MGLog(trace) << "fExtraDeadLayerBottomInnerR: " <<  fExtraDeadLayerBottomInnerR/cm << endlog; 
    MGLog(trace) << "fExtraDeadLayerMiddleInnerR: " <<  fExtraDeadLayerMiddleInnerR/cm << endlog; 
    MGLog(trace) << "fExtraDeadLayerTopInnerR: " <<  fExtraDeadLayerTopInnerR/cm << endlog; 
    MGLog(trace) << "fExtraDeadLayerBottomOuterR: " <<  fExtraDeadLayerBottomOuterR/cm << endlog; 
    MGLog(trace) << "fExtraDeadLayerMiddleOuterR: " <<  fExtraDeadLayerMiddleOuterR/cm << endlog; 
    MGLog(trace) << "fExtraDeadLayerTopOuterR: " <<  fExtraDeadLayerTopOuterR/cm << endlog; 
  */
  MGLog(trace) << "fCrystalMass (g) : " << fCrystalMass / g << endlog;
  MGLog(trace) << "fCrystalVolume (cm^3): " << fCrystalVolume/cm3 << endlog;
  MGLog(trace) << "fCrystalMaterialName: " << fCrystalMaterialName << endlog;
  MGLog(trace) << "fCutInHalf: " << fCutInHalf << endlog;
  MGLog(trace) << "----------------------------------------" << endlog;
}
