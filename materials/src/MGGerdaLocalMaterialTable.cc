...
void MGGerdaLocalMaterialTable::CreateMaterials()
{
 ...
 // tungsten
  ...
  G4Material* metalSi_SiPM_sens = new G4Material
    (name="MetalSilicon_SiPM", density=2.330*g/cm3, ncomponents=1);
  metalSi_SiPM_sens->AddElement(elSi,natoms=1);
...
//boron-ethanolamine
  ...
  G4Material* quartzTopPMT = new G4Material
    (name="QuartzTopPMT",density=2.2*g/cm3,ncomponents=2);
  quartzTopPMT->AddElement(elSi,1);
  quartzTopPMT->AddElement(elO,2);
