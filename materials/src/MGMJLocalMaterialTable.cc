...
void MGMJLocalMaterialTable::BuildElements()
{
  ...
  if(!fElementsBuilt) {
    ...
    MJElement = new G4Element("Germanium-Enr86", "Ge", 5);
    MJElement->AddIsotope(G4Isotope::GetIsotope("Germanium70"), 0.00004/1.00821);
    MJElement->AddIsotope(G4Isotope::GetIsotope("Germanium72"), 0.00009/1.00821);
    MJElement->AddIsotope(G4Isotope::GetIsotope("Germanium73"), 0.00028/1.00821);
    MJElement->AddIsotope(G4Isotope::GetIsotope("Germanium74"), 0.1268/1.00821);
    MJElement->AddIsotope(G4Isotope::GetIsotope("Germanium76"), 0.8810/1.00821);
