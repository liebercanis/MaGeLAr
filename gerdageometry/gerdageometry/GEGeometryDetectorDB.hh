 ...
 * 21-11-2017, Added two glued top and bottom rings to mini-shroud and Getters, K.v.Sturm
...
public:
  ...
  G4int GetLArInstHybridNFiberSegments()
  {return fLArInstHybridNFiberSegments;}
  ...
  G4String GetCrystalGeometryFileFormat()
  { return fCrystalGeometryFileFormat; }

  G4String GetCrystalMatrixFilename()
  { return fCrystalMatrixFilename; }

  G4String GetCrystalMatrixFileFormat()
  { return fCrystalMatrixFileFormat; }
  ...
  void SetCrystalGeometryFileFormat(G4String fileformat){ fCrystalGeometryFileFormat = fileformat; };
  void SetCrystalMatrixFilename(G4String filename);
  void SetCrystalMatrixFileFormat(G4String fileformat){ fCrystalMatrixFileFormat = fileformat; };
  ...
  void SetLArInstHybridNFiberSegments(G4int number)
  {fLArInstHybridNFiberSegments = number;}
...
private:
  ...
  G4String fCrystalGeometryFileFormat;
  G4String fCrystalMatrixFilename;
  G4String fCrystalMatrixFileFormat;
  ...
  G4int  fLArInstHybridNFiberSegments;
