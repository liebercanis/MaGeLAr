  ...
  fGeneratorPrimary(generator)
{
  ...
  fSelectCmd->SetGuidance("LGNDCables: Signal and HV cables in LGND geometry");
  ...
  candidates += "SPS neutronsGS wangneutrons AmBe sources4a GSS Pb210 DoubleBeta0 DoubleBeta2 Cable BaryonDecay LGND200Calibration LGNDLiquidArgon LGNDCables";
					      ...
					      G4String newValues)
{
  ...
  if(command == fSelectCmd) {
    ...
    else if(newValues == "LGNDCables") {
      fGeneratorPrimary->SetMGGenerator(new MGGeneratorLGNDCables() );
    }
