...
private:
	...
	G4UIdirectory	*fPb210Directory;
        G4UIcmdWithABool        *fGenerateSecondOrderCmd;
        G4UIcmdWithABool        *fGenerateXRaysCmd;
        G4UIcmdWithABool        *fGenerateElectronsCmd;
	G4UIcmdWithAString	*fSetSurfaceVolumeCmd;
        G4UIcmdWithABool        *fUseG4SurfaceSamplerCmd;
        G4UIcmdWith3VectorAndUnit *fRejectBoxCmd;
        G4UIcmdWith3VectorAndUnit *fRejectionOffsetCmd;
        G4UIcmdWith3VectorAndUnit *fRejectionRotationCmd;
