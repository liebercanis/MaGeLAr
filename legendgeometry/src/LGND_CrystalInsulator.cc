...
G4LogicalVolume* LGND_CrystalInsulator::BuildLogicalVolume()
{
  ...
  if (pVol == NULL){
    ...
    G4Box* box1 = new G4Box("box", 5.0*mm, 3.5*mm, 2.1*mm);
    G4Box* box2 = new G4Box("box2", 10.0*mm, 6.0*mm, 5.0*mm);
    G4SubtractionSolid* insulator = new G4SubtractionSolid("insulator", box1, box2, 0, G4ThreeVector(-10.0*mm, 0, (5.0-0.15)*mm));
