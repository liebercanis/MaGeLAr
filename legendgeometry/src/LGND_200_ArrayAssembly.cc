 ...
 *
 * REVISION:
 * Note that this is used for the 19 String array construction and is 
 * currently outdate
 * N. McFadden 10/28/2019 
 *
  ...
  LGND_Assembly(fName, serialNumber, "LGND_200_Strings")
{
  ...
  if(stringList.at(0) == "NULL")
    ...
    fString1Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_001", stringList.at(0),false);

  if(stringList.at(1) == "NULL")
    fString2Ptr = NULL;
  else
    fString2Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_002", stringList.at(0),false);

  if(stringList.at(2) == "NULL")
    fString3Ptr = NULL;
  else
    fString3Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_003", stringList.at(2),false);

  if(stringList.at(3) == "NULL")
    fString4Ptr = NULL;
  else
    fString4Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_004", stringList.at(3),false);

  if(stringList.at(4) == "NULL")
    fString5Ptr = NULL;
  else
    fString5Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_005", stringList.at(4),false);

  if(stringList.at(5) == "NULL")
    fString6Ptr = NULL;
  else
    fString6Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_006", stringList.at(5),false);

  if(stringList.at(6) == "NULL")
    fString7Ptr = NULL;
  else
    fString7Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_007", stringList.at(6),false);

  if(stringList.at(7) == "NULL")
    fString8Ptr = NULL;
  else
    fString8Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_008", stringList.at(7),false);

  if(stringList.at(8) == "NULL")
      fString9Ptr = NULL;
  else
      fString9Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_009", stringList.at(8),false);

  if(stringList.at(9) == "NULL")
      fString10Ptr = NULL;
  else
      fString10Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_010", stringList.at(9),false);

  if(stringList.at(10) == "NULL")
      fString11Ptr = NULL;
  else
      fString11Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_011", stringList.at(10),false);

  if(stringList.at(11) == "NULL")
      fString12Ptr = NULL;
  else
      fString12Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_012", stringList.at(11),false);

  if(stringList.at(12) == "NULL")
      fString13Ptr = NULL;
  else
      fString13Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_013", stringList.at(12),false);

  if(stringList.at(13) == "NULL")
      fString14Ptr = NULL;
  else
      fString14Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_014", stringList.at(13),false);

  if(stringList.at(14) == "NULL")
      fString15Ptr = NULL;
  else
      fString15Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_015", stringList.at(14),false);

  if(stringList.at(15) == "NULL")
      fString16Ptr = NULL;
  else
      fString16Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_016", stringList.at(15),false);

  if(stringList.at(16) == "NULL")
      fString17Ptr = NULL;
  else
      fString17Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_017", stringList.at(16),false);

  if(stringList.at(17) == "NULL")
      fString18Ptr = NULL;
  else
      fString18Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_018", stringList.at(17),false);

  if(stringList.at(18) == "NULL")
      fString19Ptr = NULL;
  else
      fString19Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_019", stringList.at(18),false);
...
LGND_200_ArrayAssembly::LGND_200_ArrayAssembly(const LGND_200_ArrayAssembly & rhs) :
  LGND_Assembly(rhs)
{
  fString1Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_001", "867-5309",false);
  fString2Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_002", "867-5309",false);
  fString3Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_003", "867-5309",false);
  fString4Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_004", "867-5309",false);
  fString5Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_005", "867-5309",false);
  fString6Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_006", "867-5309",false);
  fString7Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_007", "867-5309",false);
  fString8Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_008", "867-5309",false);
  fString9Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_009", "867-5309",false);
  fString10Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_010", "867-5309",false);
  fString11Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_011", "867-5309",false);
  fString12Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_012", "867-5309",false);
  fString13Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_013", "867-5309",false);
  fString14Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_014", "867-5309",false);
  fString15Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_015", "867-5309",false);
  fString16Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_016", "867-5309",false);
  fString17Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_017", "867-5309",false);
  fString18Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_018", "867-5309",false);
  fString19Ptr = new LGND_200_StringAssembly(fName+"_StringAssembly_019", "867-5309",false);
}
