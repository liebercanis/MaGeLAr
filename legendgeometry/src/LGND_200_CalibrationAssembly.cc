 ...
 * 03-2018, Sorted numbering and added positions for 14string ring
 */
//---------------------------------------------------------------------------//
//
...
void LGND_200_CalibrationAssembly::Place(G4ThreeVector* assemPosition, 
  ...
  // deg = pi/180.  
	if(fSourceNumber){
		switch(fSourceNumber){
			...
			case 6:
				...
				angle = 120*deg;
				break;
			//case 11-13 for 16string design, 3 middle strings missing
			case 11:
				radius = 107*mm;
				angle = 30*deg;
				break;
			...
			case 13:
				...
				angle = 150*deg;
				break;
			//case 21-23 for 16string design, 3 outer strings missing
			case 21:
				radius = 170*mm;
				angle = 0*deg;
				break;
			...
			case 23:
				...
				angle = 120*deg;
				break;
			//case 31-33 for ring design, using 3 sources
			case 31:
				radius = 150*mm;
				angle = 90*deg;
				break;
			...
			case 33:
				...
				angle = 210*deg;
				break;
			//case 41-44 for ring design, using 4 sources
			case 41:
				radius = 150*mm;
				angle = 90*deg;
				break;
    ...
    MGLog(debugging) << "\t CalibrationInnerlocalPos- " << endlog;
		...
		G4AffineTransform *LGND_200_CalibrationSourceInneraffine = new G4AffineTransform(LGND_200_CalibrationSourceInnerlocalRot, 																															               *LGND_200_CalibrationSourceInnerlocalPos);
    ...
    MGLog(debugging) << "\t CalibrationOuterlocalPos- " << endlog;
		...
		MGLog(debugging) << "--> Position Z = " << LGND_200_CalibrationSourceOuterlocalPos->z()/CLHEP::mm << " mm "  << endlog;
	  	...
	  	G4AffineTransform *LGND_200_CalibrationSourceOuteraffine = new G4AffineTransform(LGND_200_CalibrationSourceOuterlocalRot, 																																	               *LGND_200_CalibrationSourceOuterlocalPos);
      ...
      MGLog(debugging) << "\t CuAbsorberlocalPos- " << endlog;
			...
			MGLog(debugging) << "--> Position Z = " << LGND_200_CalibrationCuAbsorberlocalPos->z()/CLHEP::mm << " mm "  << endlog;
			  ...
			  G4AffineTransform *LGND_200_CalibrationCuAbsorberaffine = new G4AffineTransform(LGND_200_CalibrationCuAbsorberlocalRot, 																																		               *LGND_200_CalibrationCuAbsorberlocalPos);
