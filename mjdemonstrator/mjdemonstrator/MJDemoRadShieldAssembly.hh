...
public:
  ...
  MJDemoRadShieldPb* GetPb();
  MJDemoRadShieldPbInner* GetPbInner();
  MJDemoRadShieldPbMiddle* GetPbMiddle();
  MJDemoRadShieldPbOuter* GetPbOuter();
...
private:
  ...
  MJDemoRadShieldPbMiddle* fPbMiddlePtr;
  MJDemoRadShieldPbOuter* fPbOuterPtr;
  G4bool fIsPartitioned;
