...
public:
  ...
  void SetPbShieldPartition(G4bool doPartition) { fPartitionPbShield = doPartition; }
...
private:
  ...
  G4bool   fPartitionPbShield; //partition Pb shield into 3 sections for easier simulating
