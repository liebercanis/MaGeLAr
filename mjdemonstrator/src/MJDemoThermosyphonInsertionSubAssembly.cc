  ...
  MJVDemoAssembly(fName, serialNumber, "MJ80-11-119-R000")
{
  ...
  if(fSerialNumber.contains("TSShield")) {
    fShieldBlock01Ptr = new MJDemoTSShieldBlock(fName+"_ShieldBlock_001", "");
    fShieldBlock02Ptr = new MJDemoTSShieldBlock(fName+"_ShieldBlock_002", "");
    fShieldBlock03Ptr = new MJDemoTSShieldBlock(fName+"_ShieldBlock_003", "");
    fShieldBlock04Ptr = new MJDemoTSShieldBlock(fName+"_ShieldBlock_004", "");
